...
Code links to illustrare the different approaches can be found [here][organisation-page-emails], [here][single-page-notification-emails] and [here][world-location-news-page-email].
