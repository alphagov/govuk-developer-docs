...
title: "How to interact with the Discovery Engine REST API"
parent: "/manual.html"
...
To check that autocomplete is working correctly you can query the autocomplete endpoint (replace `<query term>` with your query string):
