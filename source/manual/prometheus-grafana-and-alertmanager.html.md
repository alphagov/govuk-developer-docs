...
Alertmanager reads data directly from Prometheus, and sends notifications when metrics cross predefined thresholds. These thresholds are defined as [rules][link-11] in [govuk-helm-charts][link-12]. See [here][link-13] on how to write these rules.
