...
[View history in old opsmanual](https://github.digital.cabinet-office.gov.uk/gds/opsmanual/tree/master/infrastructure/debian-packaging.md)
...
Import our GPG secret key from the `gds/deployment:creds` store:

    $ sudo -i gpg --import apt-1_management_production.asc
