...
If an alert fires a good place to start investigation is the
[Sidekiq monitor][monitor-workers].
...
Information about viewing this can be found on the
[Monitor Sidekiq workers][monitor-workers] page.
...
[monitor-workers]: monitor-sidekiq-workers.html
