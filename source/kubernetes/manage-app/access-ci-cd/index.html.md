...
Then GitHub Actions builds the new image and pushes that new image to AWS Elastic Container Registry (ECR) and calls the [deploy-image Argo Workflow](https://github.com/alphagov/govuk-helm-charts/blob/main/charts/argo-services/templates/workflows/deploy-image/workflow.yaml).
