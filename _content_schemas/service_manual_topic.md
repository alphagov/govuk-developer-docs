...
<table class='schema-table'><tr><td><strong>visually_collapsed</strong> <code>boolean</code></td> <td>A flag set by a content designer when they want the sections of a topic to be collapsed into an accordion. This will likely be used when there are many items in the topic.</td></tr>
...
<table class='schema-table'><tr><td><strong>linked_items</strong> </td> <td>Includes all content ids referenced in 'details'. This is a temporary measure to expand content ids for frontends which is planned to be replaced by a dependency resolution service.</td></tr>
...
<tr><td><strong>email_alert_signup</strong> </td> <td>References an email alert signup page for this topic</td></tr>
